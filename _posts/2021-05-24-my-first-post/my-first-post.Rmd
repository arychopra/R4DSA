...
6. The chart fails to indicate that the values indicated on the charts are in fact in Trillions or that it is in USD. The raw data is actually scaled down by a thousand. 
...
9. Save the file as `Import_Data.csv`
   ...
   ```
   <!--![](images/Picture_4-19.png){width=40%}-->
...
11. Open a new session of Tableau and drag the newly created Import_Data.csv.<br>
    ...
    ```
    <!--![](images/Picture_4-21.png){width=80%}-->
...
13. Merge the files
    ...
    <!--![](images/Picture_4-23.png){width=80%}-->
